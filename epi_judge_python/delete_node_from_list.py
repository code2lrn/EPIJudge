...
def deletion_from_list(node_to_delete: ListNode) -> None:
    if node_to_delete.next:
        actual_node_to_delete = node_to_delete.next
        node_to_delete.data, actual_node_to_delete.data = actual_node_to_delete.data, node_to_delete.data
        node_to_delete.next = actual_node_to_delete.next
